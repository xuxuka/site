 ...
 * @property string $viewPath The views path of the generator.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.gii
 * @since 1.1.2
...
class CCodeGenerator extends CController
{
	 ...
	 * Child classes mainly need to provide the 'index' views for collecting user parameters
	 * for code generation.
	 */
	...
	/**
	 * @param string $value the views path of the generator.
	 */
