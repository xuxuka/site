...
return array (
  ...
  'The "views" property is required.' => 'ต้องการคุณสมบัติ "views" ในการใช้งาน',
  ...
  'The requested views "{name}" was not found.' => 'ไม่พบ "{name}" ในการเรียกใช้',
  ...
  'The system views path "{path}" is not a valid directory.' => 'ระบบตรวจพบที่อยู่ "{path}" ไม่ถูกต้อง',
  ...
  'The views path "{path}" is not a valid directory.' => 'ที่อยู่ "{path}" ไม่ถูกต้อง',
  ...
  'Unable to find the decorator views "{views}".' => 'ไม่สามารถหาส่วนควบคุมของ "{views}" ได้',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} ไม่สามารถค้นหา "{views}" ตามคำสั่งได้',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} มีชุดคำสั่งที่ไม่ถูกต้องหลายอย่างในมุมมองของ "{views}" ทำให้ {widget} ไม่สามารถเรียกใช้คำสั่ง endWidget() ได้',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} กำลังถูกเรียกใช้โดย endWidget({id}) ในขณะนี้',
  '{widget} cannot find the views "{views}".' => '{widget} ไม่สามารถดู "{views}" ได้',
);
