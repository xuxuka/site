...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Δεν ήταν δυνατή η εύρεση της όψης "{name}".',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Η διαδρομή όψεων του συστήματος "{path}" δεν είναι έγκυρος κατάλογος.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Η διαδρομή όψεων "{path}" δεν είναι έγκυρος κατάλογος.',
  ...
  'View file "{file}" does not exist.' => 'Το αρχείο όψης "{views}" δεν υπάρχει.',
  ...
  '{controller} cannot find the requested views "{views}".' => 'Ο ελεγκτής {controller} δεν μπορεί να βρει την καλούμενη όψη "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => 'Ο ελεγκτής {controller} περιέχει λάθος εμφωλευμένες σημάνσεις widget στην όψη "{views}". Το widget {widget} δεν περιέχει την κλήση endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => 'Ο ελεγκτής {controller} έχει μια επιπλέον κλήση endWidget({id}) στην όψη του.',
  '{n} B' => '{n} B',
  '{n} GB' => '{n} GB',
  '{n} KB' => '{n} KB',
  '{n} MB' => '{n} MB',
  ...
  '{widget} cannot find the views "{views}".' => 'Το widget {widget} δεν μπορεί να βρει την όψη "{views}".',
);
