...
return array (
  ...
  'The "views" property is required.' => '"views" својство (property) је обавезно.',
  ...
  'The requested views "{name}" was not found.' => 'Захтевани поглед (views) "{name}" није пронађен.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Путања директоријума до системског погледа (system views) "{path}" није исправна.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Путања до директоријума views (views path) "{path}" није исправна.',
  ...
  'Unable to find the decorator views "{views}".' => 'Не могу да пронађем декоратерски поглед (decorator views) "{views}".',
  ...
  'View file "{file}" does not exist.' => 'Фајл погледа (views file) "{file}" не постоји.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} не може да пронађе захтевани поглед (views) "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} садржи непрописно угњеждене widget тагове у свом погледу (views) "{views}". {widget} widget нема endWidget() позив.',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} има сувишан endWidget({id}) позив у свом погледу (views).',
  '{widget} cannot find the views "{views}".' => '{widget} не може да пронађе поглед (views) "{views}".',
);
