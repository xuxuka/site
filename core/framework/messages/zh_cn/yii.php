...
return array (
  ...
  'The requested views "{name}" was not found.' => '找不到请求的视图 "{name}"。',
  ...
  'The "views" property is required.' => '@@需要 "views" 属性@@',
  ...
  'The requested views "{name}" is not found.' => '@@请求的 views "{name}" 未找到.@@',
  'The value for the primary key "{key}" is not supplied when querying the table "{table}".' => '@@查询 table "{table}" 时未提供 primary key "{key}" 的值.@@',
  'Unable to find the decorator views "{views}".' => '@@无法找到 decorator views "{views}".@@',
  ...
  'The system views path "{path}" is not a valid directory.' => '系统 views 路径 "{path}" 不是一个有效的目录.',
  ...
  'The views path "{path}" is not a valid directory.' => 'views 路径 "{path}" 不是一个有效的目录.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} 无法找到请求的视图 "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} 在它的 views "{views}" 中含有未被适当巢状套叠的 widget 标签. {widget} widget 中没有呼叫 endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} 在它的视图中有一个额外的 endWidget({id}) 呼叫.',
  '{widget} cannot find the views "{views}".' => '{widget} 无法找到这个视图 "{views}".',
);
