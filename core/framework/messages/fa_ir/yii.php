...
return array (
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} نمی تواند نمای در خواست شده "{views}" را پیدا کند',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} شامل تگهای نادرست ویجت در قسمت نمایش آن "{views}" می باشد',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} فراخوان زیادی برای endWidget({id}) در قسمت نمایش دارد',
  ...
  'The requested views "{name}" is not found.' => 'نمای در خواست داده شده با نام "{name}" موجود نمی باشد.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'مسیر نمای سیستم "{path}" دایرکتوری معتبری نیست.',
  ...
  'The views path "{path}" is not a valid directory.' => 'مسیر نمای "{path}" معتبر نمی باشد.',
  ...
  '{widget} cannot find the views "{views}".' => '{widget} نمیتواند قالب "{views}" را پیدا کند.',
  ...
  'The requested views "{name}" was not found.' => 'نمای {name} پیدا نشد.',
