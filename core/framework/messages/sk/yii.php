...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Požadovaný náhľad "{name}" nebol nájdený.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Cesta ku systémovému náhľadu "{path}" nie je platným adresárom.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Cesta ku náhľadu "{path}" nie je platným adresárom.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} nenašiel požadovanú šablónu "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} obsahuje nesprávne umiestnené Widget tagy v šablóne "{views}". Blok pre {widget} nemá korektne ukončený blok zavolaním metódy endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} má naviac volanú metódu endWidget ({id}) v šablóne.',
  '{n} B' => '{n} B',
  '{n} GB' => '{n} GB',
  '{n} KB' => '{n} KB',
  '{n} MB' => '{n} MB',
  ...
  '{widget} cannot find the views "{views}".' => '{widget} nenašiel šablónu "{views}".',
);
