...
return array (
  ...
  'The "views" property is required.' => '"views" svojstvo (property) je obavezno.',
  ...
  'The requested views "{name}" was not found.' => 'Zahtevani pogled (views) "{name}" nije pronađen.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Putanja direktorijuma do sistemskog pogleda (system views) "{path}" nije ispravna.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Putanja do direktorijuma views (views path) "{path}" nije validna.',
  ...
  'Unable to find the decorator views "{views}".' => 'Ne mogu da pronađem dekoratorski pogled (decorator views) "{views}".',
  ...
  'View file "{file}" does not exist.' => 'Fajl pogleda (views file) "{file}" ne postoji.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} ne može da pronađe zahtevani pogled (views) "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} sadrži nepropisno ugnježdene widget tagove u svom pogledu (views) "{views}". {widget} widget nema endWidget() poziv.',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} ima suvišan endWidget({id}) poziv u svom pogledu (views).',
  '{widget} cannot find the views "{views}".' => '{widget} ne može da pronađe pogled (views) "{views}".',
);
