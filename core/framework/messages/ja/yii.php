...
return array (
  ...
  'The requested views "{name}" was not found.' => '要求されたビュー"{name}"は見つかりません。',
  'The stack is empty.' => 'スタックが空です。',
  'The system is unable to find the requested action "{action}".' => 'システムは要求されたアクション "{action}" を見つけられません。',
  'The system views path "{path}" is not a valid directory.' => 'システムビューパス "{path}" は有効なディレクトリではありません。',
  ...
  'The views path "{path}" is not a valid directory.' => 'ビューパス "{path}" は有効なディレクトリではありません。',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} はリクエストされたビュー "{views}" を見つけられません。',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} にはビュー"{views}"の中に不適切にネストされたウィジェットタグがあります。{widget} ウィジェットには endWidget() 呼び出しがありません。',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} のビューには余分な endWidget({id}) 呼び出しがあります。',
  '{n} B' => '{n} B',
  '{n} GB' => '{n} GB',
  '{n} KB' => '{n} KB',
  '{n} MB' => '{n} MB',
  ...
  '{widget} cannot find the views "{views}".' => '{widget} はビュー "{views}" を見つけられません。',
);
