...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Không tìm thấy yêu cầu views "{name}".',
  ...
  'The system views path "{path}" is not a valid directory.' => 'View path của hệ thống "{path}" không phải là một thư mục hợp lệ.',
  ...
  'The views path "{path}" is not a valid directory.' => 'View path "{path}" không phải là một thư mục hợp lệ.',
  ...
  'View file "{file}" does not exist.' => 'File views "{file}" không tồn tại.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} không tìm được views: "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} chứa các nested widget tags không thích hợp trong views của nó "{views}". Widget {widget} không có endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} có nhiều endWidget({id}) trong views của nó.',
  '{widget} cannot find the views "{views}".' => '{widget} không thể tìm thấy file views: "{views}".',
);
