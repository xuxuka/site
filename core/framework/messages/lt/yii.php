...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Užklaustas rodinys „{name}“ nerastas.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Sisteminis rodinių kelias „{path}“ nėra galiojantis katalogas.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Rodinių kelias „{path}“ nėra galiojantis katalogas.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} neranda užklausto rodinio „{views}“.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => ' {controller} rodinyje „{views}“ neteisingai apskliaustas įterpinys. Įterpinyje {widget} neiškviečiama endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} turi pakartotinį endWidget({id}) kvietimą savo rodinyje.',
  '{widget} cannot find the views "{views}".' => '{widget} neranda rodinio „{views}“.',
);
