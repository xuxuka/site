...
return array (
  ...
  'The "views" property is required.' => '@@A propriedade "views" é deve ser informada.@@',
  ...
  'The requested views "{name}" is not found.' => '@@A visualização "{name}" não foi encontrada.@@',
  ...
  'Unable to find the decorator views "{views}".' => '@@Impossível encontrar a visualização decoradora "{views}".@@',
  ...
  'The requested views "{name}" was not found.' => 'A visualização "{name}" requisitada não foi encontrada.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'O caminho "{path}" para a visualização do sistema não é um diretório válido.',
  ...
  'The views path "{path}" is not a valid directory.' => 'O caminho "{path}" para a visualização não é um diretório válido.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} não pôde encontrar a visualização "{views}" solicitada.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} contém tags widgets aninhadas incorretamente na sua visualização "{views}". O widget {widget} não possui uma chamada endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} possui uma chamada endWidget({id}) extra em sua visualização.',
  '{widget} cannot find the views "{views}".' => '{widget} não encontrou a visualização "{views}".',
);
