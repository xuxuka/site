...
return array (
  ...
  'The requested views "{name}" was nut found.' => 'La vue demandée « {name} » n\'a pas été trouvée.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'La chemin d\'accès « {path} » à la vue système n\'est pas un dossier valide.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Le chemin d\'accès « {path} » à la vue n\'est pas un dossier valide.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} ne peut trouver la vue « {views} ».',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} contient une mauvaise imbrication des tags des widgets dans la vue « {views} ». Le widget {widget} n\'a pas d\'appel endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} a un appel à endWidget({id}) en trop dans sa vue.',
  '{widget} cannot find the views "{views}".' => '{widget} ne peut trouver la vue « {views} ».',
);
