...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Den begärda vyn "{name}" hittades inte.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Sökvägen "{path}" för systemvyn är inte en giltig katalog.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Sökvägen "{path}" för vyn är inte en giltig katalog.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} kan inte hitta den begärda vyn "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} innehåller olämpligt nästlade "widget"-taggar i vyn "{views}". En {widget} "widget" anropar inte endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} har ett extra anrop till endWidget({id}) i sin vy.',
  '{widget} cannot find the views "{views}".' => '{widget} kan inte hitta vyn "{views}".',
);
