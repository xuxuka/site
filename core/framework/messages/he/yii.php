...
return array (
  ...
  'The "views" property is required.' => '@@ערך בשם "views" חייב להיות מוגדר.@@',
  ...
  'Unable to find the decorator views "{views}".' => '@@לא ניתן למצוא את קובץ התצוגה "{views}".@@',
  ...
  'The requested views "{name}" is not found.' => 'קובץ התצוגה המבוקש "{name}" לא נמצא.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'תיקית קבצי התצוגה "{path}" אינה תקינה.',
  ...
  'The views path "{path}" is not a valid directory.' => 'תיקית קבצי התצוגה "{path}" אינה תקינה.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} לא יכל היה לאתר את קובץ התצוגה "{views}',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} מכיל שרשור תגים לא נכון של וידגטים בקובץ התצוגה "{views}". וידגט {widget} לא קורא לפקודה endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} מכיל קריאה נוספת של endWidget({id}) בקובץ התצוגה שלו.',
  '{widget} cannot find the views "{views}".' => '{widget} לא יכול לאתר את קובץ התצוגה "{views}',
);
