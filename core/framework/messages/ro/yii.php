...
return array (
  ...
  'The "views" property is required.' => 'Proprietatea "views" este obligatorie.',
  ...
  'The requested views "{name}" is not found.' => 'View-ul cerut "{name}" nu există.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Calea catre views-urile sistem "{path}" nu este un director valid.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Calea views-ului "{path}" nu este un director valid.',
  ...
  'Unable to find the decorator views "{views}".' => 'Nu se poate gasi views-ul decorativ "{views}".',
  ...
  'View file "{file}" does not exist.' => 'Fişierul views "{file}" nu există.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} nu poate gasi views-ul "{views}" cerut.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} conţine taguri de widget îmbricate necorespunzător in views-ul său "{views}". Un widget {widget} nu are un apel endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} are un apel endWidget({id}) in plus in views-ul sau.',
  '{widget} cannot find the views "{views}".' => '{widget} nu poate găsi views-ul "{views}".',
);
