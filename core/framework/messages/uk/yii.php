...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Запитуваний шаблон виду "{name}" не знайдений.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Шлях до представлень "{path}" не є директорією.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Невірний шлях представлення: "{path}".',
  ...
  '{controller} cannot find the requested views "{views}".' => 'Контролер {controller} не може знайти представлення "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => 'Контролер {controller} містить у своєму представленні "{views}" теги віджетів із невірною вкладеністю. У віджеті {widget} не використовується виклик endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => 'У представленні контролера {controller} виявлено зайвий виклик endWidget({id}).',
  '{n} B' => '{n} Б',
  ...
  '{widget} cannot find the views "{views}".' => 'Віджет {widget} не може знайти представлення "{views}".',
);
