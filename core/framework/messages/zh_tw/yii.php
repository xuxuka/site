...
return array (
  ...
  'The "views" property is required.' => '需要 "views" 屬性',
  ...
  'The requested views "{name}" is not found.' => '請求的 views "{name}" 未找到.',
  'The stack is empty.' => '堆疊狀態為空.',
  'The system is unable to find the requested action "{action}".' => '系統無法找到請求的 "{action}" 動作.',
  'The system views path "{path}" is not a valid directory.' => '系統 views 路徑 "{path}" 不是一個有效的目錄.',
  ...
  'The views path "{path}" is not a valid directory.' => 'views 路徑 "{path}" 不是一個有效的目錄.',
  ...
  'Unable to find the decorator views "{views}".' => '無法找到 decorator views "{views}".',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} 無法找到請求的 "{views}" views.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} 在它的 views "{views}" 中含有未被適當巢狀套疊的 widget 標籤. {widget} widget 中沒有呼叫 endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} 在它的 views 中有一個額外的 endWidget({id}) 呼叫.',
  '{widget} cannot find the views "{views}".' => '{widget} 無法找到這個 views "{views}".',
);
