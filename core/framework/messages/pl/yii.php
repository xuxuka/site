...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Żądany widok "{name}" nie został znaleziony.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Ścieżka widoku systemowego "{path}" nie jest prawidłowym katalogiem.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Ścieżka widoku "{path}" nie jest poprawnym katalogiem.',
  ...
  '{controller} cannot find the requested views "{views}".' => 'Kontroler {controller} nie może znaleźć wymaganego widoku "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => 'Kontroler {controller} zawiera niewłaściwie zagnieżdżone tagi widgetów w swoim widoku "{views}". Widżet {widget} nie ma wywołania endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => 'Kontroler {controller} ma dodatkowe wywołanie endWidget({id}) w swoim widoku.',
  '{widget} cannot find the views "{views}".' => 'Widżet {widget} nie może odnaleźć widoku "{views}".',
);
