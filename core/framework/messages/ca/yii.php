...
return array (
  ...
  'The requested views "{name}" was not found.' => 'No s\'ha trobat la vista sol·licitada "{name}" ',
  ...
  'The system views path "{path}" is not a valid directory.' => 'La ruta de vistes de sistema "{path}" no és un directori vàlid.',
  ...
  'The views path "{path}" is not a valid directory.' => 'La ruta de la vista "{path}" no és un directori vàlid.',
  ...
  'View file "{file}" does not exist.' => 'L\'arxiu de vista "{views}" no existeix.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} no ha pogut trobar la vista "{views}" sol·licitada.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} conté etiquetes de widget a la vista "{views}" tancades incorrectament. {widget} widget no conté la crida a endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} té una crida extra a endWidget({id}) a la seva vista.',
  '{widget} cannot find the views "{views}".' => '{widget} no ha pogut trobar la vista "{views}".',
);
