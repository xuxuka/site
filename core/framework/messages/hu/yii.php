...
'The "views" property is required.' => 'A "views" tulajdonság szükséges.',
...
'The requested views "{name}" is not found.' => 'A kért nézet "{name}" nem létezik.',
...
'The system views path "{path}" is not a valid directory.' => 'A rendszer nézet könyvtára ("{path}") érvénytele.',
...
'The views path "{path}" is not a valid directory.' => 'A(z) "{path}" Nézet útvonal nem érvényes mappanév.',
...
'Unable to find the decorator views "{views}".' => '"{views}" dekorátor Nézet fájl nem található.',
...
'{controller} cannot find the requested views "{views}".' => 'A {controller} vezérlő nem találta a(z) "{views}" Nézetet.',
'{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => 'A {controller} hibásan egymásbaágyazott widget címkéket tartalmaz a "{views}" nézetében. A {widget} widgethez nem tartozik endWidget() hívás.',
'{controller} has an extra endWidget({id}) call in its views.' => 'A {controller} nézetében van egy fölösleges endWidget({id}) hívás.',
'{widget} cannot find the views "{views}".' => 'A {widget} widget nem találta a(z) "{views}" Nézetet.',
);
