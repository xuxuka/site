...
return array (
  ...
  'The requested views "{name}" was not found.' => '요청한 views "{name}"를 찾을 수 없습니다.',
  'The stack is empty.' => '스택이 비어 있습니다.',
  'The system is unable to find the requested action "{action}".' => '시스템은 요청된 작업 "{action}"를 찾을 수 없습니다.',
  'The system views path "{path}" is not a valid directory.' => '시스템 뷰 경로 "{path}"는 올바른 디렉토리가 아닙니다.',
  ...
  'The views path "{path}" is not a valid directory.' => '뷰 패스 "{path}"는 올바른 디렉토리가 아닙니다.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller}는 요청한 views "{views}"를 찾을 수 없습니다.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller}는 views "{views}"안에 잘못 중첩된 위젯 태그를 가지고 있습니다. {widget} 위젯은 endWidget() 호출을 가지고 있지않습니다.',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller}는 view를 위해 여분의 endWidget ({id})를 호출합니다.',
  '{widget} cannot find the views "{views}".' => '{widget}는 views "{views}"를 찾을 수 없습니다.',
);
