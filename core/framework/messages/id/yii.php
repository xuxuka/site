...
return array (
  ...
  'The requested views "{name}" was not found.' => 'View "{name}" tidak ditemukan',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Path views sistem "{path}" bukan direktori yang valid.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Path tinjauan "{path}" bukan direktori yang valid.',
  ...
  'View file "{file}" does not exist.' => 'File views "{file}" tidak ada.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} tidak bisa menemukan views "{views}" yang di-request.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} berisi nested tag widget yang tidak tepat dalam views -nya "{views}". Widget {widget} tidak memiliki panggilan endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} memiliki panggilan endWidget({id}) ekstra dalam views-nya.',
  '{widget} cannot find the views "{views}".' => '{widget} tidak menemukan views "{views}".',
);
