...
return array (
  ...
  'The requested views "{name}" is not found.' => 'Den ettersprute siden ("views") "{name}" finnes ikke.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'System-side ("views") banen "{path}" er ikke en gyldig katalog.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Side-banen ("views") "{path}" er ikke en gylding katalog.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} kan ikke finne den forespurte siden "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} inneholder feil i markupen på siden "{views}". En {widget}-widget avsluttes ikke med et endWidget()-kall.',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} har et ekstra endWidget({id})-kall på siden.',
  '{widget} cannot find the views "{views}".' => '{widget} kan ikke finne siden "{views}".',
);
