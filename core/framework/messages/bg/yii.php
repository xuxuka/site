...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Поисканото views "{name}" не беше намерено.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Пътя към системния изглед "{path}" не е валидна директория.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Пътят до views файла "{path}" е невалидна ',
  ...
  '{controller} cannot find the requested views "{views}".' => 'Контролера {controller} не може да намери поисканото views "{views}"',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} съдържа неправилно поставени widget тагове в неговия "{views}" файл. {widget} widget няма извикан endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} има допълнителен endWidget({id}) извикан в неговото views.',
  '{widget} cannot find the views "{views}".' => '{widget} не може да намери views файла "{views}"',
);
