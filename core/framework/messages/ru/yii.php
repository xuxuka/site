...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Запрашиваемый шаблон вида "{name}" не найден.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Путь к представлениям "{path}" не является директорией.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Неправильный путь представления: "{path}".',
  ...
  '{controller} cannot find the requested views "{views}".' => 'Контроллер {controller} не может найти представление "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => 'Контроллер {controller} содержит в своем представлении "{views}" тэги виджетов с неправильной вложенностью. В виджете {widget} не используется вызов endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => 'В представлении контроллера {controller} обнаружен лишний вызов endWidget({id}).',
  '{n} B' => '{n} Б',
  '{n} GB' => '{n} ГБ',
  '{n} KB' => '{n} КБ',
  '{n} MB' => '{n} МБ',
  ...
  '{widget} cannot find the views "{views}".' => 'Виджет {widget} не может найти представление "{views}".',
);
