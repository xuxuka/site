...
return array (
  ...
  'The requested views "{name}" was not found.' => 'La vista solicitada "{name}" no fue encontrada.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'La ruta de vistas de sistema "{path}" no es un directorio válido.',
  ...
  'The views path "{path}" is not a valid directory.' => 'La ruta de la vista "{path}" no es un directorio válido.',
  ...
  'View file "{file}" does not exist.' => 'El archivo de vista "{views}" no existe.',
  'Yes' => 'Si',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} no ha podido encontrar la vista "{views}" solicitada.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} contiene etiquetas de widget en la vista "{views}" anidadas incorrectamente. {widget} widget no contiene la llamada a endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} tiene una llamada extra a endWidget({id}) en su vista.',
  '{n} B' => '{n} B',
  '{n} GB' => '{n} GB',
  '{n} KB' => '{n} KB',
  '{n} MB' => '{n} MB',
  ...
  '{widget} cannot find the views "{views}".' => '{widget} no ha podido encontrar la vista "{views}".',
);
