...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Сұралған "{name}" көрінісі табылмады.',
  ...
  'The system views path "{path}" is not a valid directory.' => '"{path}" жүйелік көріністер жолы бума емес болып тұр.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Көріністің "{path}" орналасу жолы дұрыс бума емес.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} контролері "{views}" көрінісін таба алмады.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} контролерінің "{views}" көрінісінде қате ішке салынған виджеттер тегтері бар. {widget} виджетінде endWidget() шақыруы қолданылмайды.',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} контролерінің көрінісінде endWidget({id}) артық шақыруы бар.',
  '{n} B' => '{n} Б',
  '{n} GB' => '{n} ГБ',
  '{n} KB' => '{n} КБ',
  '{n} MB' => '{n} МБ',
  ...
  '{widget} cannot find the views "{views}".' => '{widget} виджеті "{views}" көрінісін таба алмады.',
);
