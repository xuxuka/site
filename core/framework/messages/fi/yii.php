...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Pyydettyä näkymää "{name}" ei löytynyt.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Järjestelmän views-polku "{path}" ei ole kelvollinen hakemisto.',
  ...
  'The views path "{path}" is not a valid directory.' => 'View-polku "{path}" ei ole kelvollinen hakemisto.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} ei löydä pyydettyä näkymää "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} sisältää virheellisesti sisäkkäisiä widget-tageja "{views}"-näkymässä. {widget}-widget ei sisällä endWidget()-kutsua.',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} sisältää ylimääräisen endWidget({id})-kutsun näkymässään.',
  '{n} B' => '{n} tavua',
  '{n} GB' => '{n} Gt',
  '{n} KB' => '{n} kt',
  '{n} MB' => '{n} Mt',
  ...
  '{widget} cannot find the views "{views}".' => '{widget} ei löydä näkymää "{views}".',
);
