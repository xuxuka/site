...
return array (
  ...
  'The requested views "{name}" was not found.' => 'De opgevraagde views "{name}" werd niet gevonden.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Het views pad voor het systeem "{path}" is geen geldige map.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Het pad voor de views "{path}" is een ongeldige map.',
  ...
  'View file "{file}" does not exist.' => 'De views "{file}" bestaat niet.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} kan de opgevraagde views "{views}" niet vinden.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} bevat ongeldig genestelde widget tags in z\'n views "{views}". De {widget} widget roept endWidget() niet aan.',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} heeft een extra endWidget({id})-aanroep in z\'n views',
  '{n} B' => '{n} B',
  '{n} GB' => '{n} GB',
  '{n} KB' => '{n} KB',
  '{n} MB' => '{n} MB',
  ...
  '{widget} cannot find the views "{views}".' => '{widget} kan het viewbestand "{views}" niet vinden.',
);
