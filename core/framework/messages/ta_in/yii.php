...
return array (
  ...
  'The requested views "{name}" was not found.' => 'நீங்கள் வேண்டிய "{name}" காட்சி காணக் கிடைக்கவில்லை.',
  ...
  'The requested views "{name}" is not found.' => 'நீங்கள் வேண்டிய "{name}" காட்சி இந்த தளத்தில் இல்லை.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'தளத்தின் பார்வை முகவரி "{path}" சரியான கோர்வையைக் குறிக்கவில்லை.',
  ...
  'The views path "{path}" is not a valid directory.' => 'பார்வை முகவரி "{path}" சரியான கோர்வையைக் குறிக்கவில்லை.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} கட்டுப்பாட்டால் நீங்கள் வேண்டிய "{views}" பார்வையை கண்டுபிடிக்க இயலவில்லை.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} கட்டுப்பாடு தனது "{views}" பார்வையில் தவறாக அமைக்கப்பட்ட கருவிக் குறிகளை கொண்டுள்ளது. ஒரு {widget} கருவி endWidget() அழைப்பு இல்லாமல் இருக்கின்றது.',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} கட்டுப்பாடு அதிகமான endWidget({id}) அழைப்பை கொண்டுள்ளது.',
  '{widget} cannot find the views "{views}".' => '{widget} கருவியால் "{views}" பார்வையை காண இயலவில்லை.',
);
