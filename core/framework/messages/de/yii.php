...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Der angeforderte View "{name}" wurde nicht gefunden.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Der System-View-Pfad "{path}" ist kein gültiges Verzeichnis.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Der View-Pfad "{path}" ist kein gültiges Verzeichnis.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} kann den angeforderten View "{views}" nicht finden.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} enthält falsch verschachtelte Widget-Tags im View "{views}". Ein {widget}-Widget hat keinen endwidget()-Aufruf.',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} hat einen überzähligen endwidget({id})-Aufruf in seinem View.',
  '{n} B' => '{n} B',
  '{n} GB' => '{n} GB',
  '{n} KB' => '{n} KB',
  '{n} MB' => '{n} MB',
  ...
  '{widget} cannot find the views "{views}".' => '{widget} kann den View "{views}" nicht finden.',
);
