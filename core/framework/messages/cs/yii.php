...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Požadovaný náhled "{name}" nebyl nalezen.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Cesta k systémovému náhledu "{path}" není platným adresářem.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Cesta k náhledu "{path}" není platným adresářem.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} nenalezl požadovanou šablonu "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} obsahuje nesprávně umístěné Widget tagy v šabloně "{views}". Blok pro {widget} nemá korektně ukončený blok volaní metody endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} má navíc volanou metodu endWidget({id}) v šabloně.',
  '{n} B' => '{n} B',
  ...
  '{widget} cannot find the views "{views}".' => '{widget} nenalezl šablonu "{views}".',
);
