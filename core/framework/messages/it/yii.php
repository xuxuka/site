...
return array (
  ...
  'The "views" property is required.' => 'La proprietà "views" è richiesta.',
  ...
  'The requested views "{name}" is not found.' => 'Impossibile trovare la vista "{name}" richiesta.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Il percorso della vista di sistema "{path}" non è una cartella valida.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Il percorso della vista "{path}" non è una cartella valida.',
  ...
  'Unable to find the decorator views "{views}".' => 'Impossibile trovare la vista del decoratore "{views}".',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} non ha potuto trovare la vista "{views}" richiesta.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '{controller} contiene tag nella vista "{views}" non correttamente annidati. {widget} widget non contiene la chiamata a endWidget().',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller} contiene una chiamata extra a endWidget({id}) all\'interno della sua vista.',
  '{widget} cannot find the views "{views}".' => '{widget} non trova la vista "{views}".',
  '&lt; Previous' => '&lt; Precedente',
  '&lt;&lt; First' => '&lt;&lt; Primo',
