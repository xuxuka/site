...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Istek yapılan "{name}" görünümü bulunamadı.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Sistem görünüm yolu "{path}" geçerli biz dizin değil.',
  ...
  'The views path "{path}" is not a valid directory.' => '"{path}" görünüm yolu geçerli bir dizin değil.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller}, istenen "{views}" görünümünü bulamadı.',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => '',
  '{controller} has an extra endWidget({id}) call in its views.' => '{controller}, görünümünü çağırabilmesi için ekstra olarak endWidget({id}) içermeli.',
  '{widget} cannot find the views "{views}".' => '{widget}, "{views}" görünümünü bulamadı.',
);
