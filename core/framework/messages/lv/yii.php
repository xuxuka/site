...
return array (
  ...
  'The requested views "{name}" was not found.' => 'Pieprasītais skats "{name}" netika atrasts.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Sistēmas skata ceļš "{path}" nav korekts direktorijs.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Skata cēlš "{path}" ir nekorekts direktorijs.',
  ...
  '{controller} cannot find the requested views "{views}".' => 'Kontrolleris {controller} nevar atrast skatu "{views}".',
  '{controller} contains improperly nested widget tags in its views "{views}". A {widget} widget does not have an endWidget() call.' => 'Kontrollera {controller} skats "{views}" satur nekorekti izkārtotus vidžetu tagus. Vidžetam {widget} nav izmantots endWidget() izsaukums.',
  '{controller} has an extra endWidget({id}) call in its views.' => 'Kontrollera {controller} skatam ir lieks endWidget({id}) izsaukums.',
  '{widget} cannot find the views "{views}".' => '{widget} nevar atrast skatu "{views}".',
);
