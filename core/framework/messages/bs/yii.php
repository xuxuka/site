...
return array (
  ...
  'The requested views "{name}" was not found.' => 'zahtjevani pogled (views) "{name}" nije pronađen.',
  ...
  'The system views path "{path}" is not a valid directory.' => 'Put direktorijuma do sistemskog pogleda (system views) "{path}" nije ispravan.',
  ...
  'The views path "{path}" is not a valid directory.' => 'Put do prikaznog direktorijuma (views path) "{path}" ne važi.',
  ...
  '{controller} cannot find the requested views "{views}".' => '{controller} ne može da pronađe zahtjevani pogled (views) "{views}".',
